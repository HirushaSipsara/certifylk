...
def seed_catalogue(db: Session) -> dict[str, int]:
    ...
    gmp_reqs = [
        (
            "GMP_PREM_DESIGN",
            "Premises & Facilities",
            "Hygienic facility design and layout",
            "Production areas must be designed to prevent contamination. Traffic flows must separate raw material receipt, processing, packaging, and dispatch. Floors, walls, and ceilings must be of smooth, cleanable construction.",
            7.0,
            False,
            "SLSI GMP Guidelines",
            "Section 3.1 — Premises Design",
            1,
        ),
        (
            "GMP_PREM_LIGHT",
            "Premises & Facilities",
            "Adequate lighting in production areas",
            "All food preparation, inspection, and storage areas must have adequate, safe lighting. Light fittings above open food must be shatter-resistant or shielded.",
            4.0,
            False,
            "SLSI GMP Guidelines",
            "Section 3.2 — Lighting",
            2,
        ),
        (
            "GMP_PREM_VENT",
            ...
            "Effective ventilation must prevent condensation, remove cooking odours and vapours, and prevent air-borne contamination of food. Air flow must not move from contaminated to clean areas.",
            5.0,
            True,
            "SLSI GMP Guidelines",
            "Section 3.3 — Ventilation",
            3,
        ),
        (
            "GMP_PREM_SANIT",
            "Premises & Facilities",
            "Dedicated sanitary facilities for staff",
            "Clean toilet facilities separate from production areas must be available for all staff. Handwashing signs must be posted. Facilities must not open directly to food handling areas.",
            4.0,
            True,
            "SLSI GMP Guidelines",
            "Section 3.4 — Sanitary Facilities",
            4,
        ),
        (
            "GMP_PERS_HEALTH",
            "Personnel Hygiene",
            "Food handler health screening policy",
            "Personnel showing symptoms of illness including diarrhoea, vomiting, skin lesions, or respiratory infection must be excluded from food contact areas. A health declaration procedure must be documented.",
            6.0,
            True,
            "SLSI GMP Guidelines",
            "Section 4.1 — Health Screening",
            5,
        ),
        (
            "GMP_PERS_DRESS",
            "Personnel Hygiene",
            "Protective clothing and PPE use",
            "All food handlers must wear clean protective clothing (overalls/aprons), head covering, and appropriate footwear. Jewellery, watches, and mobile phones must not be worn in production areas.",
            5.0,
            False,
            "SLSI GMP Guidelines",
            "Section 4.2 — Protective Clothing",
            6,
        ),
        (
            "GMP_PERS_WASH",
            "Personnel Hygiene",
            "Handwashing compliance and training",
            "Staff must wash hands at defined checkpoints: entry to production area, after toilet use, after handling raw materials, and after any contamination risk. Training records must be maintained.",
            4.0,
            True,
            "SLSI GMP Guidelines",
            "Section 4.3 — Handwashing Procedures",
            7,
        ),
        (
            "GMP_EQUIP_DESIGN",
            "Equipment & Maintenance",
            "Food-grade, cleanable equipment surfaces",
            "All equipment in contact with food must be made of food-grade, non-toxic, non-corrosive materials. Surfaces must be smooth, non-porous, and designed for easy cleaning and inspection.",
            6.0,
            True,
            "SLSI GMP Guidelines",
            "Section 5.1 — Equipment Design",
            8,
        ),
        (
            "GMP_EQUIP_MAINT",
            ...
            "A documented preventive maintenance schedule must be maintained. Maintenance activities must be recorded. Equipment must be re-cleaned and sanitised after maintenance before food production resumes.",
            5.0,
            False,
            "SLSI GMP Guidelines",
            "Section 5.2 — Preventive Maintenance",
            9,
        ),
        (
            "GMP_EQUIP_CALIB",
            ...
            "Thermometers, scales, pH meters, and other critical measuring instruments must be calibrated at defined intervals. Calibration records must be retained.",
            4.0,
            False,
            "SLSI GMP Guidelines",
            "Section 5.3 — Calibration",
            10,
        ),
        (
            "GMP_WATER_POTABLE",
            ...
            "Water used in food production, cleaning, and as an ingredient must meet Sri Lanka potable water standards. Non-potable water systems must be clearly identified and physically separated.",
            7.0,
            True,
            "SLSI GMP Guidelines",
            "Section 6.1 — Water Supply",
            11,
        ),
        (
            "GMP_WATER_TEST",
            ...
            "Potable water used in food production must be tested microbiologically and chemically at least annually by an accredited laboratory. Test records must be retained.",
            3.0,
            False,
            "SLSI GMP Guidelines",
            "Section 6.2 — Water Testing",
            12,
        ),
        (
            "GMP_PROD_CTRL",
            ...
            "All production steps must be documented with defined parameters (time, temperature, speed, concentration). Deviations must be recorded and assessed before product release.",
            6.0,
            False,
            "SLSI GMP Guidelines",
            "Section 7.1 — Process Control",
            13,
        ),
        (
            "GMP_PROD_REWORK",
            "Production Controls",
            "Rework and non-conforming product control",
            "Non-conforming products must be clearly identified and segregated. A documented procedure for rework, rejection, or disposal must be followed and recorded.",
            4.0,
            False,
            "SLSI GMP Guidelines",
            "Section 7.3 — Non-Conforming Product",
            14,
        ),
        (
            "GMP_PROD_ALLERGEN",
            "Production Controls",
            "Allergen management",
            "If allergens are present in the facility, procedures must prevent cross-contact. Allergens must be declared on labels in accordance with the Food Act regulations.",
            5.0,
            True,
            "SLSI GMP Guidelines",
            "Section 7.4 — Allergen Control",
            15,
        ),
        (
            "GMP_PEST_PROGRAMME",
            "Pest & Waste Control",
            "Documented pest control programme",
            "A licensed pest control contractor must inspect at defined intervals. Maps of bait stations and traps must be maintained. Evidence of pest activity must trigger documented corrective action.",
            5.0,
            True,
            "SLSI GMP Guidelines",
            "Section 8.1 — Pest Control",
            16,
        ),
        (
            "GMP_WASTE_MGMT",
            ...
            "Food and non-food waste must be collected in covered, identified containers and removed from production areas frequently. Waste storage areas must not attract pests.",
            5.0,
            False,
            "SLSI GMP Guidelines",
            "Section 8.2 — Waste Management",
            17,
        ),
        (
            "GMP_DOC_RECORDS",
            "Documentation & Records",
            "Mandatory GMP record set",
            "The following records must be maintained: cleaning logs, pest control records, staff training records, maintenance logs, calibration records, and non-conformance reports. Minimum retention: 2 years.",
            5.0,
            False,
            "SLSI GMP Guidelines",
            "Section 9.1 — Record Keeping",
            18,
        ),
    ]
    ...
    haccp_reqs = [
        (
            "HACCP_TEAM",
            "HACCP Foundations",
            "Designated HACCP team with defined roles",
            "A multi-disciplinary HACCP team must be appointed. At least one member must have formal HACCP training. Roles and responsibilities must be documented.",
            5.0,
            False,
            "Codex Alimentarius CAC/RCP 1-1969 / SLSI HACCP Guidelines",
            "Principle 0 — HACCP Team",
            1,
        ),
        (
            "HACCP_SCOPE",
            "HACCP Foundations",
            "Defined product description and intended use",
            "A written description of each product including composition, physicochemical properties, packaging, shelf life, and intended consumer must be documented before hazard analysis.",
            5.0,
            False,
        ...
        (
            ...
            "A process flow diagram must be drawn for every product covered by the HACCP plan. The diagram must be verified on-site to confirm it accurately reflects actual production.",
            5.0,
            False,
            "Codex Alimentarius CAC/RCP 1-1969",
            "Steps 4–5 — Process Flow Diagram",
            3,
        ),
        (
            "HACCP_HAZ_BIO",
            "Hazard Analysis",
            "Biological hazard identification for each process step",
            "For each step in the process flow, biological hazards (pathogens, spoilage organisms) must be systematically identified and their likelihood and severity assessed.",
            7.0,
            True,
            "Codex Alimentarius CAC/RCP 1-1969 — Principle 1",
            "Step 6 — Biological Hazard Analysis",
            4,
        ),
        (
            "HACCP_HAZ_CHEM",
            ...
            "Chemical hazards (pesticide residues, cleaning chemical contamination, natural toxins, allergens) must be identified at each step and assessed for significance.",
            7.0,
            True,
            "Codex Alimentarius CAC/RCP 1-1969 — Principle 1",
            "Step 6 — Chemical Hazard Analysis",
            5,
        ),
        (
            "HACCP_HAZ_PHYS",
            "Hazard Analysis",
            "Physical hazard identification and assessment",
            "Physical hazards (glass, metal, bone, plastic) must be identified at each step and assessed for likelihood and severity. Detection controls must be specified.",
            6.0,
            True,
            "Codex Alimentarius CAC/RCP 1-1969 — Principle 1",
            "Step 6 — Physical Hazard Analysis",
            6,
        ),
        (
            "HACCP_CCP_IDENT",
            "Critical Control Points",
            "CCP identification using decision tree",
            "Critical Control Points (CCPs) must be identified for significant hazards using a systematic decision tree or equivalent method. The rationale for CCP determination must be documented.",
            8.0,
            True,
            "Codex Alimentarius CAC/RCP 1-1969 — Principle 2",
            "Step 7 — CCP Determination",
            7,
        ),
        (
            "HACCP_CL_DEFINED",
            ...
            "Validated critical limits (e.g. minimum cooking temperature, maximum pH, minimum Brix) must be established for every CCP. Limits must be based on scientific evidence or regulatory requirement.",
            9.0,
            True,
            "Codex Alimentarius CAC/RCP 1-1969 — Principle 3",
        ...
        (
            ...
            "Each critical limit must have documented scientific justification or reference to a recognised authority (e.g. SLSI, FSAI, Codex). Validation records must be retained.",
            8.0,
            True,
            "Codex Alimentarius CAC/RCP 1-1969 — Principle 3",
            "Step 8 — CL Validation",
            9,
        ),
        (
            "HACCP_MON_PROCEDURE",
            "Monitoring & Corrective Action",
            "Defined monitoring procedures for each CCP",
            "For each CCP, a defined monitoring procedure must specify: what is measured, how it is measured, frequency, and the responsible person. Monitoring must be able to detect loss of control in time.",
            8.0,
            True,
            "Codex Alimentarius CAC/RCP 1-1969 — Principle 4",
        ...
        (
            "HACCP_MON_RECORDS",
            "Monitoring & Corrective Action",
            "CCP monitoring records completed at time of operation",
            "Monitoring records must be completed by the responsible person at the time of observation. Records must include the actual measured value, not just pass/fail. Signature and date required.",
            7.0,
            True,
            "Codex Alimentarius CAC/RCP 1-1969 — Principle 4",
            "Step 9 — Monitoring Records",
            11,
        ),
        (
            "HACCP_CA_PROCEDURE",
            ...
            "A documented corrective action procedure must be in place for each CCP. It must specify: who is responsible, what happens to affected product, and how the root cause is addressed.",
            7.0,
            True,
            "Codex Alimentarius CAC/RCP 1-1969 — Principle 5",
        ...
        (
            "HACCP_CA_RECORDS",
            "Monitoring & Corrective Action",
            "Corrective action events recorded",
            "Every corrective action triggered by a CCP deviation must be documented, including the nature of the deviation, disposition of the affected product, and preventive measure implemented.",
            6.0,
            False,
            "Codex Alimentarius CAC/RCP 1-1969 — Principle 5",
            "Step 10 — Corrective Action Records",
            13,
        ),
        (
            "HACCP_VERIF_INTERNAL",
            "Verification & Validation",
            "Internal verification audit schedule",
            "Periodic internal verification activities (e.g. internal audits, CCP record review, equipment calibration checks) must be scheduled and carried out at least annually. Findings must be documented.",
            5.0,
            False,
            "Codex Alimentarius CAC/RCP 1-1969 — Principle 6",
        ...
        (
            "HACCP_VERIF_LAB",
            "Verification & Validation",
            "End-product or environmental microbiological testing",
            "Microbiological testing of finished product or processing environment must be conducted periodically to verify the effectiveness of the HACCP plan.",
            5.0,
            False,
            "Codex Alimentarius CAC/RCP 1-1969 — Principle 6",
        ...
        (
            "HACCP_DOC_PLAN",
            "Documentation & Records",
            "Documented and approved HACCP plan",
            "A written HACCP plan covering all seven HACCP principles must be in place. The plan must be reviewed and approved by management and reviewed whenever there is any change to product, process, or ingredients.",
            5.0,
            False,
            "Codex Alimentarius CAC/RCP 1-1969 — Principle 7",
            "Step 12 — HACCP Documentation",
            16,
        ),
        (
            "HACCP_DOC_RETENTION",
            ...
            "HACCP monitoring records, corrective action records, verification records, and the HACCP plan must be retained for a minimum period sufficient to cover the product shelf life plus one year, or as required by regulation.",
            3.0,
            False,
            "Codex Alimentarius CAC/RCP 1-1969 — Principle 7",
            "Step 12 — Record Retention",
            17,
        ),
        (
            "HACCP_TRAINING",
            "HACCP Foundations",
            "HACCP team and operator training",
            "All HACCP team members must receive formal HACCP training. Production operators working at CCPs must receive role-specific training. Training records must document the content, date, trainer, and attendees.",
            5.0,
            False,
            "SLSI HACCP Guidelines",
            "Section 2.3 — Training Requirements",
            18,
        ),
        (
            "HACCP_PREREQ",
            "HACCP Foundations",
            "Documented prerequisite programmes (PRPs)",
            "Prerequisite programmes including GMP, pest control, cleaning and sanitation, water control, and allergen management must be documented and maintained as the foundation of the HACCP system.",
            5.0,
            False,
            "Codex Alimentarius CAC/RCP 1-1969",
        ...
        (
            "HACCP_REVIEW",
            "Documentation & Records",
            "HACCP system review after significant change",
            "The HACCP plan must be formally reviewed whenever there is a change in raw materials, product formulation, processing methods, equipment, packaging, intended use, or a food safety incident.",
            2.0,
            False,
            "Codex Alimentarius CAC/RCP 1-1969 — Principle 7",
    ...
    iso_reqs = [
        (
            ...
            "Defined FSMS scope and organizational context",
            "The scope of the Food Safety Management System must be defined, including the products, processes, and sites covered. Internal and external factors relevant to food safety must be identified (ISO 22000 Clause 4.1–4.3).",
            5.0,
            False,
            "ISO 22000:2018",
            "Clause 4.1–4.3 — Context and Scope",
            1,
        ),
        (
            "ISO_CTX_INTERESTED",
            "Organizational Context",
            "Interested party needs and regulatory requirements identified",
            "The needs and expectations of interested parties (customers, regulators, consumers) relevant to food safety must be identified and considered in the FSMS design.",
            5.0,
            False,
            "ISO 22000:2018",
        ...
        (
            ...
            "Food safety policy established and communicated",
            "Top management must establish a food safety policy appropriate to the organization's purpose. The policy must be documented, communicated to all staff, and reviewed periodically.",
            5.0,
            False,
            "ISO 22000:2018",
        ...
        (
            "ISO_LEAD_ROLES",
            "Leadership & Commitment",
            "FSMS roles and responsibilities defined",
            "Top management must appoint a Food Safety Team Leader and define FSMS roles and responsibilities. Authority must be documented to enable the FSMS to function effectively.",
            5.0,
            False,
            "ISO 22000:2018",
        ...
        (
            "ISO_PLAN_OBJECTIVES",
            "Planning",
            "Measurable food safety objectives established",
            "Food safety objectives must be set, measurable, consistent with the policy, and reviewed. Plans to achieve objectives must include resources, responsible persons, timelines, and evaluation methods.",
            5.0,
            False,
            "ISO 22000:2018",
            "Clause 6.2 — Food Safety Objectives",
            5,
        ),
        (
            "ISO_PLAN_RISK",
            "Planning",
            "Risk and opportunity assessment for FSMS",
            "Risks and opportunities relevant to the FSMS must be determined and addressed through planning actions. This includes both positive opportunities (e.g. technology improvements) and negative risks (e.g. supply chain disruption).",
            5.0,
            False,
            "ISO 22000:2018",
        ...
        (
            ...
            "Infrastructure PRPs — premises, equipment, and utilities",
            "PRPs addressing infrastructure (building, equipment, utilities including water, energy, and ventilation) must be documented, implemented, and monitored to prevent food safety hazards.",
            6.0,
            True,
            "ISO 22000:2018",
        ...
        (
            "ISO_PRP_CLEAN",
            "Prerequisite Programmes",
            "Cleaning and disinfection PRP",
            "A documented cleaning and disinfection PRP must define schedules, methods, materials, and verification. Records must confirm completion.",
            5.0,
            True,
            "ISO 22000:2018",
            "Clause 8.2 — Cleaning & Disinfection PRP",
            8,
        ),
        (
            "ISO_PRP_ALLERGEN",
            "Prerequisite Programmes",
            "Allergen management PRP",
            "An allergen management PRP must identify allergens present and specify procedures to prevent cross-contact. Allergen declarations on labels must be controlled.",
            5.0,
            True,
            "ISO 22000:2018",
            "Clause 8.2 — Allergen PRP",
            9,
        ),
        (
            "ISO_PRP_PERSONNEL",
            "Prerequisite Programmes",
            "Personnel hygiene and training PRP",
            "A documented personnel hygiene PRP must specify requirements for health screening, protective clothing, handwashing, and training. Records of training completion must be maintained.",
            4.0,
            False,
            "ISO 22000:2018",
            "Clause 8.2 — Personnel Hygiene PRP",
            10,
        ),
        (
            "ISO_HACCP_ANALYSIS",
            "HACCP Plan",
            "FSMS HACCP hazard analysis completed",
            "A complete hazard analysis must identify biological, chemical, and physical hazards at each process step. Risk assessment must determine which hazards are significant and require OPRP or CCP control.",
            8.0,
            True,
            "ISO 22000:2018",
        ...
        (
            "ISO_HACCP_CCPS",
            "HACCP Plan",
            "CCPs and OPRPs defined with critical limits",
            "Critical Control Points (CCPs) and Operational PRPs (OPRPs) must be established for all significant hazards. Critical limits must be defined and scientifically validated.",
            9.0,
            True,
            "ISO 22000:2018",
            "Clause 8.5.4–8.5.7 — CCPs and OPRPs",
            12,
        ),
        (
            "ISO_HACCP_MONITOR",
            "HACCP Plan",
            "CCP and OPRP monitoring system in operation",
            "A monitoring system for each CCP and OPRP must be implemented and records maintained. The monitoring frequency must be sufficient to ensure control is maintained.",
            8.0,
            True,
            "ISO 22000:2018",
            "Clause 8.5.4.3 — Monitoring",
            13,
        ),
        (
            "ISO_OPS_TRACEABILITY",
            "Operational Controls",
            "Traceability system for all food materials",
            "A traceability system must enable identification of material lots, processing records, and distribution destinations. Product recall must be achievable within 24 hours.",
            6.0,
            False,
            "ISO 22000:2018",
        ...
        (
            ...
            "Procedures must be in place to respond to potential emergency situations or accidents affecting food safety. Crisis management roles and communication plans must be documented.",
            4.0,
            False,
            "ISO 22000:2018",
            "Clause 8.4.2 — Emergency Preparedness",
            15,
        ),
        (
            "ISO_OPS_WITHDRAWAL",
            ...
            "A documented withdrawal/recall procedure must be in place, tested at defined intervals, and ensure affected product can be identified and removed from the market rapidly.",
            5.0,
            True,
            "ISO 22000:2018",
            "Clause 8.9.5 — Product Recall",
            16,
        ),
        (
            "ISO_EVAL_INTERNAL",
            ...
            "An internal audit programme covering all elements of the FSMS must be conducted at planned intervals. Auditors must not audit their own work. Findings and corrective actions must be recorded.",
            5.0,
            False,
            "ISO 22000:2018",
        ...
        (
            ...
            "Top management must review the FSMS at planned intervals to ensure its continued suitability, adequacy, and effectiveness. Management review outputs must include decisions on FSMS improvement.",
            5.0,
            False,
            "ISO 22000:2018",
        ...
        (
            "ISO_EVAL_KPI",
            "Performance Evaluation",
            "Key performance indicators for food safety objectives",
            "Measurable food safety KPIs must be monitored and reported in management reviews to demonstrate progress towards food safety objectives.",
            5.0,
            False,
            "ISO 22000:2018",
        ...
        (
            ...
            "A documented nonconformity management process must ensure root cause analysis and corrective action for all significant FSMS failures. Effectiveness of corrective actions must be verified.",
            5.0,
            False,
            "ISO 22000:2018",
        ...
        (
            ...
            "The organisation must continually improve the suitability and effectiveness of the FSMS. Actions taken for improvement must be reviewed for effectiveness in the next management review.",
            5.0,
            False,
            "ISO 22000:2018",
        ...
        (
            "ISO_IMPROVE_UPDATE_FSMS",
            "Improvement",
            "FSMS updated following system changes",
            "The FSMS documentation and HACCP plan must be updated whenever there is a change in products, processes, ingredients, technology, regulatory requirements, or food safety incidents.",
            5.0,
            False,
            "ISO 22000:2018",
            "Clause 10.3 — FSMS Update",
            22,
        ),
    ]
