    ...
    <section className="space-y-4" aria-label="Assessment score summary">
      ...
      {completeness === 0 && (
        <p className="rounded-2xl border border-sky-200 bg-sky-50 px-5 py-4 text-sm leading-6 text-slate-700">
          No supporting documents were uploaded, so evidence completeness is 0%. Your readiness score may still reflect information provided in your business profile and production-process answers.
        </p>
      )}
    </section>
  );
